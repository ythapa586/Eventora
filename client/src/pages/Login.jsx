    ...
    <div className="login-root">
        ...
        <div className="left-content">
          ...
          <div className="left-headline">
            ...
            <p className="left-sub">
              Sign in and step into experiences crafted for the extraordinary.
            </p>
      ...
      <div className="login-right">
        <div className="form-container">
          ...
          {/* Heading */}
          <p className="form-eyebrow">{showOTP ? 'Verify Identity' : 'Welcome back'}</p>
          <h1 className="form-title">
            {showOTP ? <>Enter<br />Your Code</> : <>Sign<br />In</>}
          </h1>
          <p className="form-subtitle">
            {showOTP
              ? `We sent a 6-digit code to ${email}`
              : 'Access your Eventora account'}
          </p>
          ...
          <form onSubmit={handleSubmit} noValidate>
              ...
              <>
                ...
                <div className="input-group">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <a href="#" style={{ fontSize: 12, color: 'var(--gold)', textDecoration: 'none', letterSpacing: '0.05em' }}>Forgot?</a>
                  </div>
                  <div className="input-wrap">
                    <LockIcon />
                    <input
            ...
            <button type="submit" className="submit-btn" disabled={loading}>
              {loading
                ...
                : <>{showOTP ? 'Verify & Sign In' : 'Sign In'} <ArrowRight /></>
              }
            </button>
          </form>
